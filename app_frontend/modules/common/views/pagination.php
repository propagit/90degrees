<?php
	...
	if($total_records > $records_per_page){
		  ...
		  if($current_page > 1){
			  $page_numbers = '<li data-page-no="1"><a href="#"><i class="fa fa-angle-double-left"></i></a></li><li data-page-no="'.($current_page-1).'"><a href="#"><i class="fa fa-angle-left"></i></a></li>'.$page_numbers;
		  }
		  if($current_page < $pages){
			  if($current_page < $pages){
				  $page_numbers = $page_numbers.'<li data-page-no="'.($current_page+1).'"><a href="#"><i class="fa fa-angle-right"></i></a></li><li data-page-no="'.$pages.'"><a href="#"><i class="fa fa-angle-double-right"></i></a></li>';
			  }
			  else{
				  $page_numbers = $page_numbers.'<li data-page-no="'.$pages.'"><a href="#"><i class="fa fa-angle-double-right"></i></a></li>';
			  }
		  }
	}
	#echo $page_numbers;
